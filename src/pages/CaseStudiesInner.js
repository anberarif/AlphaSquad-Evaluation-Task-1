...
class CaseStudiesInner extends Component {
  render() {
    return (
      <div>
      <div class=" bg-gradient-to-r from-yellow-200 via-red-300 to-pink-300 h-auto">
      ...
      <HText classs="font-extrabold text-4xl animate-pulse">Trello x Weber</HText>
...
There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
      ...
      <HText classs="font-semibold text-black-700 text-center">
      Breakdown of milestones
      </HText>
      <HText classs="text-center">
...
There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
      ...
      <div class="text-black h-auto p-10 grid grid-flow-row  gap-4 clear-both bg-gradient-to-r from-pink-300 via-pink-400 to-pink-600">
      ...
      <WebButton class="place-self-center rounded-sm  text-black bg-pink-200 ">Start trial</WebButton>
      <WebButton class="place-self-center rounded-sm  text-black border-2 border-pink bg-transparent ">Contact sales</WebButton>
      </div>
      </div>
      </div>
        </div>
      ...
      <hr/>
<div class=" p-4 bg-gray-50  bg-gradient-to-r from-yellow-200 via-red-300 to-pink-300 bg-pink-200">
